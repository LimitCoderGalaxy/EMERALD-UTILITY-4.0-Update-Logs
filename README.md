...
3. Create `.env`:
   ...
   # Optional weather support for /weather
   WEATHER_API_KEY=
   ```
...
## Notes
- Slash command cap is 100 per Discord application.
- Keep your GitHub log repo up to date so `/updates` reflects your latest release notes.
- If command changes are not visible immediately, redeploy and restart.
